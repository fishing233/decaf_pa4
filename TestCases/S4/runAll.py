...
if __name__ == '__main__':
    ...
    for name in names:
        ...
        our_result = read_txt_file(os.path.join('result',bname+'.du'))
        ...
        # Check the result
        reference = read_txt_file(os.path.join('output',bname+'.result'))
        our_result = read_txt_file(os.path.join('result',bname+'.result'))
